...
-- custom by Konstantin
maps.i["kj"] = { "<Esc><cmd>wa<cr>", desc = "Exit insert mode and write all changed files" }
maps.n["mo"] = { "o<Esc>k", desc = "Add empty line below" }
maps.n["mO"] = { "O<Esc>j", desc = "Add empty line above" }
maps.n["<leader>a"] = { "ggVG", desc = "Switch to visual mode and select all." }
